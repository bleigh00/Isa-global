            ...
            <div class="panel with-nav-tabs panel-default">
                <div  class="panel-heading" align="center">
                        <ul class="nav nav-tabs" >
                            <li class="active"><a href="#tab1danger" data-toggle="tab">History</a></li>
                            <li><a href="#tab2danger" data-toggle="tab">Goal</a></li>
                            <li><a href="#tab3danger" data-toggle="tab">People we serve</a></li>
                            <li><a href="#tab4danger" data-toggle="tab">Our Sponsors</a></li>
                           
                        </ul>
                </div>
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="tab1danger"><p>The Institute for Social Advancement (ISA) is a New York
                         based non-profit founded in 2011 with the mission to help communities whose access to basic necessities is limited.
                          We advance human welfare by developing sustainable education programs that allow the inhabitants to advocate for
                           themselves and their communities. ISA seeks to establish a world free of poverty by increasing their standards 
                           of living Where citizens are held accountable for their communities thriving socially and flourishing economically.
                            We seek a society where individuals strive to develop leadership, independence and self governance. ISA works 
                            to provide the people and tools necessary to foster such communities. Our mission is to help communities 
                            whose access to basic necessities is limited. We advance human welfare by developing sustainable programs
                             that allow the inhabitants of the targeted regions to become self – sufficient and to be able to advocate for 
                             themselves and their communities. The Institute for Social Advancement (ISA) is a New York based non-profit
                              founded in 2011 with the mission to help communities whose access to basic necessities is limited. We advance 
                              human welfare by developing sustainable education programs that allow the inhabitants to advocate for themselves
